...
This update uses PANTHER 19.0 and pathway associations 3.6.8. Entrez mappings
reuse the UniProt-to-Entrez snapshot downloaded on 2023-09-20. Source releases,
the mapping snapshot date, and checksums are recorded in the database metadata.
